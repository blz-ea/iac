...
resource "proxmox_virtual_environment_file" "debian-10-6-0-amd64-netinst" {
  content_type = "iso"
  ...
  source_file {
    path = "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-10.6.0-amd64-netinst.iso"
  }
}
